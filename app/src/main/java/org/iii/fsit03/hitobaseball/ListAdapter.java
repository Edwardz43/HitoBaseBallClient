...
public class ListAdapter extends BaseExpandableListAdapter {
    ...
    public ListAdapter(LayoutInflater inflater , Activity context, List<String> Items,
    ...
    public View getChildView(final int groupPosition, final int childPosition,
        ...
        if (ListView == null) {
            ListView = inflater.inflate(R.layout.layout_child_roster, null);
        }

        TextView item = (TextView) ListView.findViewById(R.id.textView1);
        //Log.i("brad", item.toString());
...
//                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            ListView = inflater.inflate(R.layout.layout_parent_roster,null);
        }
        TextView item = (TextView) ListView.findViewById(R.id.textView1);
        //Log.i("brad", item.toString());
